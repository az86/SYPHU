...
{
    public class PLLatinSquareVarAnaTable : VarianceAnalysisTable
    {
        public String[] TableVerticalHeader = new string[] { "组内", "组间", "非平行", "非线性", "处理组","行", "列", "残差", "总和" };

        public override void InitTable()
        {
            VarAnaTable.IsSeparator = true;
            VarAnaTable.RowNum = 10;
